export class ArchiveChatPage {
  constructor(page) {
    ...
    this.unArchiveButton = page.locator("//div[@class='flex-1 hidden md:flex flex-col overflow-hidden bg-gray-50']//button[@title='Unarchive']//*[name()='svg']//*[name()='path' and contains(@fill,'currentCol')]");
  }
